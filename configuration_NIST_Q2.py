...
pi_half_len = 48 # needs to be a multiple of 4
...
config = {
    ...
    "controllers": {
        "opx-1": {
            "type": "opx1",
            "analog_outputs": {
                1: {"offset": -0.0112},  # qubit I
                2: {"offset": 0.0054},  # qubit Q
                3: {"offset": -0.01},  # rr I
                4: {"offset": -0.0042},  # rr Q
            },
            "digital_outputs": {},
            "analog_inputs": {
                1: {"offset": -0.133905029296875+0.010612618582589285,"gain_db": 3},  # rr I
                2: {"offset": -0.13981288364955358+0.021638706752232142,"gain_db": 3}  # rr Q
            },
        },
    },
    ...
    "elements": {
        ...
        "rr": {
            ...
            "time_of_flight": 272, #without smearing # should be multiple of 4 (at least 24)
    ...
    "mixers": {
        "mixer_q1": [{"intermediate_frequency": qb_IF, "lo_frequency": qb_LO, "correction": IQ_imbalance(-0.0105,-0.0425)}],
        "mixer_rl1": [{"intermediate_frequency": rr_IF, "lo_frequency": rr_LO, "correction": IQ_imbalance(0.0075,-0.065)}],
    }
}
