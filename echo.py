...
t_min = 1
t_max = 2000 # Maximum pulse duration (in clock cycles, 1 clock cycle = 4 ns)
dt = 20  # timestep
...
print(end-start)
pf.pulse_plot(sequence='echo', t_vector=4*t_arr, y_vector=I,dt=dt,qubitDriveFreq=qb_LO + qb_IF,amp_q=gauss_amp)
